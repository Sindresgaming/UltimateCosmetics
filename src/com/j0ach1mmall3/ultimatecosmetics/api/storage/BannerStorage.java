...
/**
 * Created by j0ach1mmall3 on 10:07 22/08/2015 using IntelliJ IDEA.
 */
public final class BannerStorage {
    ...
    public BannerStorage(Main plugin, String identifier, CustomItem item, int position, String permission) {
        this.plugin = plugin;
